...
from wim_metrics.pipeline import run_report
from wim_metrics.serialization import ExistingOutputError


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate a weekly WIM support report.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        path = run_report(args.week, force=args.force)
